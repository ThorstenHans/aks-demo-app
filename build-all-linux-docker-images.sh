...
echo -e 'building backend docker image as \033[1;34mthhdemo.azurecr.io/sessions-ms:latest\033[0m'
docker build . -f sessions-ms.Dockerfile -t thhdemo.azurecr.io/sessions-ms:latest --quiet
echo -e 'building backend docker image as \033[1;34mthhdemo.azurecr.io/votings-ms:latest\033[0m'
docker build . -f votings-ms.Dockerfile -t thhdemo.azurecr.io/votings-ms:latest --quiet
echo -e 'building backend docker image as \033[1;34mthhdemo.azurecr.io/auditlog-cleaner:latest\033[0m'
docker build . -f auditlog-cleaner.Dockerfile -t thhdemo.azurecr.io/auditlog-cleaner:latest --quiet

echo -e 'building backend docker image as \033[1;34mthhdemo.azurecr.io/export-ms:latest\033[0m'
docker build . -f export-ms.Dockerfile -t thhdemo.azurecr.io/export-ms:latest --quiet
